-- ============================================================================
-- MediFlow AI — 0004_fix_pos_function.sql
-- Replaces create_sale with fixes found during E2E:
--   1. Cast CASE expressions to the payment_status enum (text -> enum error).
--   2. Accumulate cost of goods (v_cost was never summed -> profit always 0).
--   3. Explicit enum casts on the invoices.status and payments.status inserts.
-- ============================================================================
