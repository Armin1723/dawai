-- ============================================================================
-- MediFlow AI — 0012_fix_customer_payment_order.sql
-- Recreate record_customer_payment with a deterministic FIFO tiebreaker
-- (order by sold_at, id) so two sales created in the same instant settle in
-- a stable order. Applied after 0011 was already pushed live.
-- ============================================================================
